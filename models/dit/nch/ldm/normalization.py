...
class AdaLayerNormZero(nn.Module):
    ...
    def __init__(self, embedding_dim: int, num_embeddings: Optional[int] = None, norm_type="layer_norm", bias=True, input_dim=None):
        super().__init__()
        if num_embeddings is not None:
        ...
        self.linear = nn.Linear(input_dim, 6 * embedding_dim, bias=bias)
...
class AdaLayerNormZeroSingle(nn.Module):
    ...
    def __init__(self, embedding_dim: int, norm_type="layer_norm", bias=True, input_dim=None):
        super().__init__()
...
if is_torch_version(">=", "2.1.0"):
    ...
    # TODO: replace with torch layer norm once min required torch version >= 2.1
